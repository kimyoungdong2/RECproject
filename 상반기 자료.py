...
for p in range(1,101):
    ...
    for l in range(100):
        ...
        for i in range(len(First_Quantitative_Volume)):
            if First_Quantitative_Volume[i] < 0:
        ...
        for i in range(len(Second_Quantitative_Volume)):
            if Second_Quantitative_Volume[i] < 100:
        ...
        for i in range(len(Third_Quantitative_Volume)):
            if Third_Quantitative_Volume[i] < 2100:
        ...
        for j in range(len(First_Middle_Pass)):
            for k in range(j + 1, len(First_Middle_Pass)):
                if (Upper_Limit-First_Middle_Pass[j][0])/Upper_Limit*0.7+ First_Middle_Pass[j][2]*0.3 < (Upper_Limit-First_Middle_Pass[k][0])/Upper_Limit*0.7 + First_Middle_Pass[k][2]*0.3:
        ...
        for j in range(len(Second_Middle_Pass)):
            for k in range(j + 1, len(Second_Middle_Pass)):
                if (Upper_Limit-Second_Middle_Pass[j][0])/Upper_Limit*0.7+ Second_Middle_Pass[j][2]*0.3 < (Upper_Limit-Second_Middle_Pass[k][0])/Upper_Limit*0.7 + Second_Middle_Pass[k][2]*0.3:
        ...
        for j in range(len(Third_Middle_Pass)):
            for k in range(j + 1, len(Third_Middle_Pass)):
                if (Upper_Limit-Third_Middle_Pass[j][0])/Upper_Limit*0.7+ Third_Middle_Pass[j][2]*0.3 < (Upper_Limit-Third_Middle_Pass[k][0])/Upper_Limit*0.7 + Third_Middle_Pass[k][2]*0.3:
    ...
    print(p/10,First_Middle_Index/100,Second_Middle_Index/100,Third_Middle_Index/100)
    First_Middle_Index,Second_Middle_Index,Third_Middle_Index=0,0,0
