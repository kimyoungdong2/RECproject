...
First_Quantitative_Volume = Randoms_Price(First_Number, First_Average, Standard_Deviation)
...
for i in range(len(Final_Pass)):
    if Final_Pass[i][1] <= 150 and Final_Pass[i] in First_Final_Pass:
        First_Get.append(Final_Pass[i])
    elif 100 <= Final_Pass[i][1] <=4500  and Final_Pass[i] in Second_Final_Pass:
